...
<head>
    ...
    <title>@ViewBag.Title - MPCNirvana</title>
...
<body ng-app="rsApp">
            ...
            <div Class="row">
                <div Class="col-md-3" style="margin-top: 15px;">
                    <div class="logo-header">
                        <div class="pull-left mobo-widthtab"><a href="/" class="link-underline"><h2 class="uni-logo"><img src="~/Content/images/Nirvana.png" class="ninja-logo" />MPCNirvana</h2></a></div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="http://docs.mpcnirvana.com" target="_blank">Documentation</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div Class="container body-content">
        ...
        <footer>
            <p>&copy; @DateTime.Now.Year - MPCNirvana</p>
        </footer>
    </div>
