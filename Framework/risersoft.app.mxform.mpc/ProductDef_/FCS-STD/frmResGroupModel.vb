...
<DataContract>
Public Class frmResGroupModel
    Inherits clsFormDataModel

    Protected Overrides Sub InitViews()
        myView = Me.GetViewModel("ResGroup")
    End Sub
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        If myUtils.cBoolTN(myRow("isother")) Then
            myView.MainGrid.QuickConf(Sql, True, "1.25-0-0-0-0-2-1-1", True, "Resources")
        ...
        Else
            myView.MainGrid.QuickConf(Sql, True, "1.25-0.5-1.5-1-0.75-2-1-1", True, "Resources")
            myView.MainGrid.PrepEdit("<BAND INDEX=""0"" IDFIELD=""PlnResourceMemID"" TABLE=""PlnResourceMem""><COL KEY=""PlnResourceID,PlnResourceGroupID,Qty,Rank""/></BAND>", EnumEditType.acCommandAndEdit)
        End If
    ...
    Public Overrides Function Validate() As Boolean
        Me.InitError()
        If myUtils.cStrTN(Me.myRow("ResGroupName")).Trim.Length = 0 Then Me.AddError("ResGroupName", "Enter Group Name")
        If Me.myView.MainGrid.myDS.Tables(0).Select.Length = 0 Then Me.AddError("", "Select ResGroup")
    ...
    Public Overrides Function VSave() As Boolean
        VSave = False
        If Me.Validate Then
            Dim ResGroupDescrip As String = myRow("ResGroupName").ToString
            Try
                ...
                myView.MainGrid.SaveChanges(, "PlnResourceGroupid=" & frmIDX)
                frmMode = EnumfrmMode.acEditM
                myContext.Provider.dbConn.CommitTransaction(ResGroupDescrip, frmIDX)
                VSave = True
            Catch e As Exception
                myContext.Provider.dbConn.RollBackTransaction(ResGroupDescrip, e.Message)
                Me.AddException("", e)
            End Try
        End If
    End Function
